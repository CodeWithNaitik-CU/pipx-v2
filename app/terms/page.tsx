    ...
    <main className="min-h-screen bg-[#0A0E14] text-[#F5F7FA] font-sans">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-gray-300 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-white mb-2">3. Eligibility & Geographic Restrictions</h2>
            <p>
              Participants must be at least 18 years old and legally permitted to participate in
              skill-based paid competitions under the laws of their jurisdiction.
            </p>
            <p className="mt-3">
              <strong className="text-white">PipX is not offered to residents of India.</strong>{" "}
              Regardless of where PipX or its operator is based, individuals residing in India are
              not permitted to create an account, enter tournaments, or otherwise use PipX's paid
              services. It is the participant's sole responsibility to confirm their eligibility
              under their local laws before entering any tournament, and to accurately represent
              their country of residence.
            </p>
          </section>

          <section>
            <h2 className="font-display text-lg font-bold text-white mb-2">4. Entry Fees & Refunds</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-white mb-2">5. Prizes & Payouts</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-white mb-2">6. Fair Play</h2>
            <p>
          ...
          <section>
            <h2 className="font-display text-lg font-bold text-white mb-2">7. Market Data</h2>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              principles, notwithstanding that PipX's services are not offered to Indian
              residents. Any disputes shall be subject to the jurisdiction of Indian courts.
            </p>
          </section>
